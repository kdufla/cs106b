...
/*
 * this method uses recursion to build map which allows us to search codes for chars 
 */
...
/*
 * this method uses recursion to build map which allows us to search chars for codes 
 */
